function updateOutput() {
  ...
  + parseFloat(out_carbon_amazon.value*0.001) + parseFloat(out_carbon_youtube.value*0.001) + parseFloat(out_carbon_spotify.value*0.001)
  ).toFixed(2);
  out_water.value = (parseFloat(out_water_netflix.value)
  + parseFloat(out_water_hulu.value) + parseFloat(out_water_amazon.value)
  + parseFloat(out_water_youtube.value) + parseFloat(out_water_spotify.value)).toFixed(2);
  out_land.value = (parseFloat(out_land_netflix.value)
  + parseFloat(out_land_hulu.value) + parseFloat(out_land_amazon.value)
  + parseFloat(out_land_youtube.value) + parseFloat(out_land_spotify.value)).toFixed(2);
}
